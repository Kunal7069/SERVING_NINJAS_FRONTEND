...
function EducatorPanel() {
  ...
  const fetchAppointments = async () => {
    ...
    try {
      ...
      console.log(name)
      const response = await fetch('https://serving-ninjas.onrender.com/educator-appointment/by-educator', {
        method: 'POST',
        headers: {
  ...
  const handleSubmit =  async (e) => {
    ...
    try {
    const response = await fetch('https://serving-ninjas.onrender.com/educator', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
